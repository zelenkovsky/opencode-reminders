...
Coverage includes persistence, scheduler execution and cancellation fencing, restoration cadence,
atomic lease ownership/recovery, and multiprocess prompt contention. Child-process tests use strict
stdin barriers and are responsible for closing their children during cleanup.
